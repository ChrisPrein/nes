    ...
    def get_cart(self, interrupt_listener):
        ...
        if self.py_compatibility_mode:
            if self.mapper_id==0:
                ...
                raise ValueError("Mapper {} not currently supported in py_compatibility_mode".format(self.mapper_id))
        ...
        if self.mapper_id == 0:
            ...
            raise ValueError("Mapper {} not currently supported".format(self.mapper_id))
